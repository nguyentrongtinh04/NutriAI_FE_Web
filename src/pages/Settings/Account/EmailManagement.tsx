                            ...
                            <button
                              onClick={async () => {
                                try {
                                  ...
                                  notify.info("📩 Verification code has been sent to your email.");
                                } catch {
                                  notify.error("❌ Failed to request phone unlink.");
                                }
                              }}
                                ...
                                <button
                                  onClick={async () => {
                                    try {
                                      ...
                                      notify.success("❎ Phone number unlinked successfully!");
                                      dispatch(fetchMe());
                                      setShowPhoneUnlinkInput(false);
                                      setUnlinkPhoneOtp("");
                                    } catch {
                            ...
                            <button
                              onClick={async () => {
                                try {
                                  ...
                                  notify.info("📩 OTP has been sent to your email.");
                                  setShowConfirmPhoneOtp(true);
                                  setShowPhoneForm(false);
                                  setPhoneNumber("");
                                  setPhonePassword("");
                                } catch {
                                  notify.error("❌ The phone number already exists or has an invalid format.");
                                }
                              }}
                              className="bg-green-500 hover:bg-green-600 text-white px-4 py-3 rounded-xl w-full font-semibold transition-all duration-200"
                            >
                            ...
                            <button
                              onClick={async () => {
                                try {
                                  ...
                                  notify.error("❌ The OTP is incorrect or has expired.");
                                }
                              }}
                          ...
                          <GoogleLogin
                            onSuccess={async (credentialResponse) => {
                              ...
                              try {
                                ...
                                notify.error("❌ This Google account does not match the current account.");
                              }
                            }}
                          ...
                          <button
                            onClick={async () => {
                              try {
                                ...
                                notify.info("📩 OTP has been sent to your phone number.");
                              } catch {
                                notify.error("❌ Unable to request Google unlinking.");
                              }
                            }}
                            className="flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white px-4 py-3 rounded-xl w-full font-semibold transition-all duration-200 shadow-md hover:shadow-lg"
                          >
                              ...
                              <button
                                onClick={async () => {
                                  try {
                                    ...
                                    notify.success("❎ Google account unlinked successfully!");
                                    dispatch(fetchMe());
                                    setShowGoogleUnlinkInput(false);
                                    setUnlinkGoogleOtp("");
                                  } catch {
