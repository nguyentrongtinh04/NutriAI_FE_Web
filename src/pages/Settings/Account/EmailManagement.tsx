...
import { requestEmailChange, confirmEmailChange, linkGoogle, linkPhone, sendEmailVerification, verifyEmail } from "../../../redux/actions/authActions";
        ...
        <div className="bg-white/95 backdrop-blur-3xl border-2 border-green-200/60 rounded-3xl p-8 shadow-2xl">
          {emails.map((email) => (
            <div key={email.id} className="p-4 rounded-xl border-2 bg-gray-50 mb-4">
              ...
              {/* OTP verify email (Hiện sau khi bấm Verify) */}
              {showVerifyInput && (
                ...
                {profile?.phone ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <button
                      onClick={async () => {
                        try {
                          await dispatch(linkPhone(newEmail, updateOtp));
