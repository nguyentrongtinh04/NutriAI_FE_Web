            ...
            <div className="h-full flex flex-col relative z-10">
                ...
                <div className="flex-1 overflow-y-auto px-8 py-6">
                    <div className="grid grid-cols-12 gap-6 h-full">
                        ...
                        <div className={`space-y-4 transition-all duration-500 ${aiMode === "ON" ? "col-span-3" : "col-span-4"}`}>
                        ...
                        <div className={`space-y-4 transition-all duration-500 ${aiMode === "ON" ? "col-span-4" : "col-span-7"}`}>
        ...
        `}
                        ...
                        {aiMode === "ON" && (
                            <div className="col-span-5 transition-all duration-500">
                                <div className="relative group h-full">
                                    <div className="absolute -inset-1 bg-gradient-to-r from-pink-400 via-rose-400 to-red-400 rounded-2xl blur-lg opacity-50"></div>
                                    ...
                                    <div className="relative bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-6 border border-pink-200/50 h-full flex flex-col">
                                        <div className="border-b border-pink-100 pb-4 mb-5 flex items-center justify-between">
                                            <h3 className="font-bold text-xl bg-gradient-to-r from-pink-700 to-rose-700 bg-clip-text text-transparent flex items-center gap-2">
                ...
                <div className="bg-white/95 backdrop-blur-xl shadow-2xl border-t border-blue-200/50 px-8 py-4 flex items-center justify-end">
                    <div className="flex items-center gap-4">
                        ...
                        <button
                            ...
                            disabled={aiLoading || aiMode === "OFF" || !isFormValid()}
                            className="relative group/btn px-6 py-2.5 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-xl flex items-center gap-2 disabled:opacity-50 hover:from-blue-700 hover:to-cyan-700 font-medium transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
                        >
                        ...
                        <button
                            onClick={async () => {
                                ...
                                if (hasActive) {
                                    notify.warning("⚠️ Bạn đã có lịch đang hoạt động.");
                                    return;
                                }
                                setShowModal(true);
                            }}
                            disabled={!canCreateSchedule}
                            className={`px-6 py-2.5 rounded-xl text-white flex items-center gap-2 transition-all duration-300 font-medium shadow-lg
    ${canCreateSchedule
                        ...
                        {/* AI OFF BOX */}
                        {aiMode === "OFF" && (
                            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm rounded-xl px-4 py-2 shadow-md border border-gray-200">
