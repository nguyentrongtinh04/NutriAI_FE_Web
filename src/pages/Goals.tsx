...
export default function Goals({ onBack, previousPageLabel = 'Danh sách lịch trình' }: GoalsProps) {
  ...
  // Xác định chỉ số cột hôm nay (grid 8 cột: 1 = "Bữa ăn", 2..8 = ngày trong tuần)
  const todayCol = useMemo(() => {
    const todayStr = new Date().toDateString();
    const idx = weekDates.findIndex(d => d.toDateString() === todayStr); // 0..6 hoặc -1
          ...
          <div className="relative z-40 grid grid-cols-8 border-b border-gray-200 bg-transparent">
            <div className="p-4 border-right border-gray-200">
              <div className="text-sm font-bold text-gray-700 text-center flex items-center justify-center gap-2">
                ...
                <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">Bữa ăn</span>
              </div>
            </div>
          ...
          <div className="relative z-40 grid grid-cols-8 bg-transparent">
            <div className="p-4 border-r border-gray-200 flex items-center justify-center">
              <span className="text-sm font-bold text-gray-700 flex items-center gap-2">
                ...
                <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Ghi chú</span>
              </span>
            </div>
