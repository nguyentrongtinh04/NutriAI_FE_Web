        ...
        <div className="bg-white/60 backdrop-blur-xl rounded-3xl shadow-[8px_8px_20px_rgba(0,0,0,0.05)] p-8 sm:p-10">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-2">
              ...
              <button
                type="button"
                className="flex-1 border border-[#90c2e7] px-6 py-3 rounded-full text-l font-extrabold text-[#1c3c64] hover:bg-[#e3f3fd] transition backdrop-blur-sm bg-white/40"
              >
                Register
              </button>
            </div>
