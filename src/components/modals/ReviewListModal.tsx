     ...
     <div className="bg-white rounded-3xl w-full max-w-4xl shadow-2xl max-h-[90vh] flex flex-col animate-fadeIn overflow-hidden">
        <div className="bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-6 rounded-t-3xl flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-2xl font-bold text-white">Danh sách đánh giá</h2>
          </div>
          <button
        ...
        <div className="flex-1 overflow-y-auto p-8">
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-16">
              ...
              <p className="text-gray-400 text-sm mt-2">Hoàn thành lịch trình để thêm đánh giá đầu tiên</p>
            </div>
          ) : (
                  ...
                  <div className="p-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      ...
                      <div className="flex items-center gap-3 bg-white/60 rounded-xl p-3">
                        ...
                        <div>
                          <p className="text-xs text-gray-500 font-medium">Cân nặng</p>
                          <p className="text-sm font-semibold text-gray-800">
                      ...
                      <div className="flex items-center gap-3 bg-white/60 rounded-xl p-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-semibold text-gray-800">
                            {item.daysCompleted}/{item.totalDays} ngày
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    {item.extraActivities && item.extraActivities.length > 0 && (
                      <div className="mb-4 bg-white/60 rounded-xl p-4">
                        <p className="text-sm font-semibold text-gray-700 mb-2">Hoạt động thêm:</p>
                    ...
                    <div className="border-t border-gray-200 pt-4 mt-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                          <p className="text-sm font-semibold text-gray-700 mb-1">Độ khó:</p>
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 italic">"{item.feedback.comment}"</p>
                        </div>
                      </div>
                    </div>
                  </div>
